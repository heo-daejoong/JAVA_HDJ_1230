...
# CGV사이트를 참고하여 미키 17 영화를 등록할 때 필요한 쿼리들을 작성하세요.
# 영화 등록
...
# abc123 회원이 2번 스케줄(미키 17, 4관, 3월 11일, 19:10)의 예약 가능한 좌석 A1, A2를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM) VALUES
(1, 1, 27000, 1, 2);
# 예매 리스트 테이블(TICKET_LIST)에 추가하는 쿼리
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUES
...
# abc123 회원이 2번 스케줄(미키 17, 4관, 3월 11일, 19:10)의 예약 가능한 좌석 A3, A4를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM) VALUES
(1, 1, 27000, 1, 2);
# 예매 리스트 테이블(TICKET_LIST)에 추가하는 쿼리
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUES
