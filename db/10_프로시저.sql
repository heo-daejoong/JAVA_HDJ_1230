...
# AVERAGE 테이블에 등록된 학생만큼 1학년 1학기에서 3학년 2학기 평균 초기 데이터를 추가하는 프로시저
...
# AVERAGE 테이블에 SUM과 COUNT 모두 0으로 초기화
...
# SCORE테이블에 있는 학생 성적들을 이용하여 AVERAGE테이블에 SUM과 COUNT를 계산하는 프로시저
...
BEGIN
    ...
    DECLARE _CURSOR CURSOR FOR 
		SELECT SC_ST_KEY, SC_SCORE, SJ_GRADE AS SC_GRADE, SJ_SEMESTER AS SC_SEMESTER 
		FROM SCORE
