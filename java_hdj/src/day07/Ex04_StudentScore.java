...
public class Ex04_StudentScore {
	...
	public static void main(String[] args) {
		...
		//0번지에 1학년 1반 1번 홍길동 국어 100을 가지는 객체를 저장하세요
		...
		do {
			...
			switch(menu){
			case 1:
				/* 스캐너를 이용하여 학년, 반, 번호, 이름, 과목, 점수를 입력받는 코드를 작성하세요*/
				System.out.print("학년 : ");
				...
				break;
			case 2:
				// 0번지부터 count-1번지까지 1씩 증가하면서 list에 있는 학생 정보를 출력하는 코드를 작성하세요.
			...
			case 3:
				...
				score = scan.nextInt();
				int index = -1;
				/* 0번지부터 count-1까지 list에서 하나씩 꺼내서 list에 정보와 위에서 입력받은
				 * 학년, 반, 번호, 과목 정보가 같으면 index에 해당 번호를 저장하고 break로 빠져나옴
				 * */
				for(int i = 0; i < count; i++) {
...
class Student{
	 ...
	 * 매개변수 : 주어진 정보 => int score, int num, int grade, int classNum
	...
	public void print(){
		System.out.println(grade + "학년 " + classNum + "반 " + num + "번 " + name + " " + subject + " : " + score);
	}
