...
public class Ex01_AccountBook2 {
	...
	private static void deleteItem(Item[] list, int count, int index) {
		for(int i = index + 1; i < count; i++) {
			list[i - 1] = list[i]; 
		}
	}

	private static void updateItemList(Item[] list, int count) {
	...
	private static boolean checkIndex(int index, int count) {
...
class Item{
	String income, type, content, date;
	int money;
