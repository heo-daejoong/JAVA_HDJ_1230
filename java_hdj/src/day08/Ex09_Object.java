...
public class Ex09_Object {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		Student std2 = new Student(1, 1, 2, "임꺽정", "국어", 100);
...
class Student implements Cloneable{
	...
	@Override
	public int hashCode() {
		return Objects.hash(classNum, greade, num, subject);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return classNum == other.classNum && greade == other.greade && num == other.num
