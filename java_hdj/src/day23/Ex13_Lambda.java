...
public class Ex13_Lambda {
	...
	public static void main(String[] args) {
		...
		//x좌표가 0 이상인 좌표들만 출력되도록 메소드를 만들어서 테스트하세요.
		//printListX(list);
		//y좌표가 0 이상인 좌표들만 출력되도록 메소드를 만들어서 테스트하세요.
		//printListY(list);
		...
		System.out.println("-------------------");
		//람다식으로 x좌표가 0 이상인 좌표들만 출력되도록 메소드를 만들어서 테스트하세요.
		printList(list, p->p.getX() >= 0);
		
		System.out.println("-------------------");
		//람다식으로 y좌표가 0 이상인 좌표들만 출력되도록 메소드를 만들어서 테스트하세요.
