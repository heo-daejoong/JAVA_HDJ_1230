...
public class Ex01_Client {
	 ...
	 * - 회원가입
	 *  - 아이디, 비번, 비번 확인을 입력해서 회원가입
	 * - 로그인
	 *  - 아이디, 비번을 입력해서 회원이면 제품 조회로, 아니면 메인으로 돌아감
	 *  - 관리자이면 관리자 메뉴로 이동
	 * */
	/* 메인 메뉴
	 * 1. 로그인
	...
	private static void insertProduct() {
		...
		System.out.print("제품 분류(문구, 의류, 식품, 가전, 기타) : ");
